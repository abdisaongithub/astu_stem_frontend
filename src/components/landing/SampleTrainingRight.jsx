...
const SampleTrainingRight = () => {
    return (
        <div className="flex px-10 mt-20">
            <div className="w-1/2">
                <div className="flex-col mx-3">
                    <h1 className='font-bold text-[64px] text-left'>Physics</h1>
                    <p className="text-justify">It is a calm sonic shower, sir. It is a calm sonic shower, sir. It
...
export default SampleTrainingRight